                        ...
                        <div class="col-lg-12">
                            <div class="card shadow-lg">
                                <div class="card-body">
                                    <ul>
                                        <li>
                                            Pengajuan Cuti tahunan <strong>paling lama 10 hari</strong> sebelum
                                            melaksanakan Cuti dan maksimal cuti <strong>12 hari</strong>
                                        </li>
                                        <li class="mt-2">
                                            Pengajuan Cuti besar <strong>paling lama 10 hari</strong> sebelum
                                            melaksanakan Cuti dan maksimal cuti <strong>3 bulan</strong>
                                        </li>
                                        <li class="mt-2">
                                            Pengajuan Cuti bersalin diajukan terhitung <strong>1,5 bulan (satu setengah
                                                bulan)</strong> sebelum
                                            melahirkan
                                        </li>
                                    </ul>
                                </div>
