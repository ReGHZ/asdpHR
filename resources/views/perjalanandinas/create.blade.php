...
<!--Delete penugasan Modal -->
<div class="modal fade text-left" id="penugasanDelete" tabindex="-1" role="dialog"
    aria-labelledby="myModalLabel120" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header bg-danger">
                <h5 class="modal-title white" id="myModalLabel120">Hapus Penugasan Perjalanan Dinas
                </h5>
                <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                    <i data-feather="x"></i>
                </button>
            ...
            <div class="modal-body">
                <form action="{{ route('perjalanan-dinas.destroy') }}" method="post">
                    @method('delete')
                    @csrf
                    <p class="text-center">Apakah kamu ingin menghapus Penugasan ?</p>
