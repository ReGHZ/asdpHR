...
@section('content')
                            ...
                            <div class="col-lg-12">
                                <div class="p-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" readonly id="jumlah_harga" name="jumlah_harga_tiket"
                            ...
                            <div class="col-lg-12">
                                <div class="p-3">
                                    ...
                                    <div class="form-group">
                                        <label class="form-control-label">Jumlah</label>
                                        <input class="form-control" readonly id="jumlah_harga" name="jumlah_harga_tiket"
                                            placeholder="NaN" :value="jumlah_tiket(datarealisasi)">
                                    </div>
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Biaya Harian</h1>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            ...
                                            <input id="p_lama_hari" readonly type="text" class="form-control"
                                                v-model="datarealisasi.lama_hari">
                                        </div>
                                        <div class="col-sm-6">
                                            <label class="form-control-label">Biaya harian</label>
                                            <input name='biaya_harian' id="biaya_harian" type="text"
                                    ...
                                    <div class="form-group">
                                        <label class="form-control-label">Jumlah</label>
                                        <input class="form-control" readonly id="hasilharian" name="jumlah_biaya_harian"
                                            placeholder="NaN" :value="jumlah_harian(datarealisasi)">
                                    </div>
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Biaya penginapan!</h1>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" readonly id="totalsemua" placeholder="NaN"
                                            :value="jumlah_keseluruhan(datarealisasi)">
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <!-- Delete RAB Modal -->
    <div class="modal fade text-left" id="rabDelete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel160"
        aria-hidden="true">
