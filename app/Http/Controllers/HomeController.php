...
class HomeController extends Controller
{
    ...
    public function index()
    {
        try {
            ...
            // dd($groupCuti);
            return view('layouts.home', compact('todayDate', 'pengajuanCuti', 'perjalananDinas', 'pegawai', 'grafikMasaKerja', 'grafikMasaJabatan', 'pengajuanCuti', 'grafikCutiUsers', 'grafikCuti'));
        } catch (\Exception $e) {
